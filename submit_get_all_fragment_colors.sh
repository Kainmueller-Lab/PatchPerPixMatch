...
# base_lm_swc_path=/nrs/saalfeld/kainmuellerd/ppp/setup22_200511_00/test/400000/
# base_lm_swc_path=/nrs/saalfeld/kainmuellerd/ppp_Barry/setup22_200511_00/test/400000/
...
do
  ...
  bsub -P $billing -n 2 -W 03:00 -o $log_file python -W ignore get_all_fragment_colors.py \
                --raw-path ${raw_path} \
                --inst-path ${inst_path} \
                --lm-vol ${vol} \
                --inst-key $inst_key \
